...
const APPROVED_SOURCE_REGISTER_MARK = /Source Register v1\.0\.0 PRELIMINARY/i;
...
export function validateAuthoringText({ filename, text }) {
  ...
  if (APPROVED_SOURCE_REGISTER_MARK.test(text)) {
    warnings.push('Source Register v1.0.0 is approved; drop PRELIMINARY from Canonical Source Foundations');
  }
