...
// OCR manifests serialize type:"image" as metadata for locally extracted text.
// That is not an external image part. Block actual data-URL / multimodal payloads.
const forbiddenPayload = /data:image\/|;base64,|"type"\s*:\s*"input_image"|"(?:data|image_url)"\s*:\s*"[A-Za-z0-9+/]{256}/i;
