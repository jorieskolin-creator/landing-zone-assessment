...
const EVENT_FIELDS = Object.freeze({
  ...
  stage_exhausted: ['stage', 'attempt_count', 'error_code', 'failed_models', 'failed_codes'],
  ...
  kb_index_loaded: ['documents', 'failures', 'source', 'kb_content_status', 'kb_pack_version'],
  kb_index_fallback: ['documents', 'failures', 'source', 'kb_content_status', 'kb_pack_version'],
  ...
  batch_attempt_failed: ['batch', 'attempt', 'error_code', 'failed_models', 'failed_codes'],
  batch_failed: ['batch', 'error_code', 'failed_models', 'failed_codes'],
