...
const source = (await readFile(new URL('../src/services/sourceRegistryService.ts', import.meta.url), 'utf8'))
  .replace(
    ...
    "const BATCH_TITLES = { A: 'Cost Visibility & Allocation', B: 'Rate & Usage Optimization', C: 'Governance & Policy', D: 'Architecture & Engineering', E: 'Culture & Organization', F: 'GenAI & AI Cost Management' }; const DOMAIN_ROUTING_TERMS = { A: ['allocation', 'tagging', 'tag', 'showback', 'chargeback', 'dashboard', 'reporting', 'cost visibility', 'unit economics', 'cost per', 'anomaly', 'alert', 'owner', 'cost center'], B: ['reservation', 'reserved instance', 'savings plan', 'commitment', 'rightsizing', 'right-size', 'utilization', 'waste', 'idle', 'orphaned', 'spot', 'preemptible', 'storage lifecycle', 'tiering'], C: ['policy', 'governance', 'budget', 'forecast', 'approval', 'guardrail', 'procurement', 'vendor', 'compliance', 'regulatory', 'raci', 'operating model', 'finops operating'], D: ['architecture', 'engineering', 'infrastructure as code', 'terraform', 'pulumi', 'cloudformation', 'autoscaling', 'auto scaling', 'serverless', 'container', 'kubernetes', 'multi-cloud', 'hybrid', 'design review'], E: ['culture', 'organization', 'team', 'finance', 'engineering accountability', 'platform team', 'finops team', 'enabling team', 'training', 'kpi', 'incentive', 'collaboration', 'community'], F: ['genai', 'generative ai', 'llm', 'token', 'tokens', 'model routing', 'prompt', 'context window', 'rag', 'embedding', 'openai', 'anthropic', 'gemini', 'inference', 'ai cost', 'model spend', 'api usage', 'ai budget'] };"
  )
  .replace(
