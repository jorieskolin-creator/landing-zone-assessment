...
assert.match(intakeHero, /href="\/Landing_Zone_Assessment_Summary_Report.html"/);
assert.match(intakeHero, /href="\/Landing_Zone_Assessment_Master_Data_Report.html"/);
...
assert.match(orchestrator, /unavailableEvidenceCheck\(batchId, failure\.error_code\)/, 'failed domains must produce explicit unavailable evidence decisions');
