...

{
  ...
  assert.ok(
    ...
    && forensicIndex > reconciliationIndex
    && forensicIndex < sanitationIndex
    && sanitationIndex < calculationIndex,
    'runtime Landing Zone scoring must remain downstream of provenance, LZ forensic evaluation, and final sanitation',
  );
}
